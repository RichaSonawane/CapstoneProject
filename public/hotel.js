...
const listCallback = ({ data: list }) => displayList(list);
...
const createList = (body) =>
  axios
    .post("http://localhost:4040/api/list/", body)
    .then(listCallback)
    .catch(errCallback);
...
function createListCard(list) {
  ...
  <div class="card-header">Day ${list.day}</div>
    <h4 class="card-title">${list.header}</h4>
